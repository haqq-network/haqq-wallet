...
export type AddressCosmos = `haqq${string}`;
...
export type IndexerTime = Record<AddressCosmos | AddressEthereum, number>;
...
export type IndexerTxMsgWithdrawDelegatorReward = {
  delegator_address: AddressCosmos;
  validator_address: AddressCosmos;
...
export type IndexerTxMsgSend = {
  from_address: AddressCosmos;
  to_address: AddressCosmos;
  amount: IndexerCoin[];
...
export type IndexerTxMsgEthereumErc20TransferTx = {
  contract_address: AddressCosmos;
  from_address: AddressCosmos;
  to_address: AddressCosmos;
  amount: IndexerCoin;
...
export type IndexerTxMsgBeginRedelegateTx = {
  delegator_address: AddressCosmos;
  validator_src_address: AddressCosmos;
  validator_dst_address: AddressCosmos;
  amount: IndexerCoin;
