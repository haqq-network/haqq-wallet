...
import {CARD_SHADOW_COLOR, SYSTEM_BLUR_2} from '../variables';
    ...
    <Card
      ...
      <View style={[page.topNav, !wallet.mnemonicSaved && page.marginBottom]}>
        ...
        <IconButton onPress={onPressQR} style={page.qrButton}>
          <QRCode color={getColor(Color.graphicBase3)} />
        </IconButton>
        <CopyButton style={page.copyButton} value={wallet.address}>
          <Text t14 style={page.address}>
            {formattedAddress}
          </Text>
          <Copy color={getColor(Color.graphicBase3)} style={page.marginLeft} />
        </CopyButton>
      </View>
      ...
      <View style={page.buttonsContainer}>
        <View style={page.button}>
          ...
          <IconButton style={page.spacer} onPress={onPressSend}>
            <ArrowSend color={getColor(Color.graphicBase3)} />
        ...
        <View style={page.button}>
          ...
          <IconButton style={page.spacer} onPress={onPressQR}>
            <ArrowReceive color={getColor(Color.graphicBase3)} />
            <Text clean style={page.buttonText}>
              Receive
            </Text>
          </IconButton>
...
const page = createTheme({
  ...
  button: {
    ...
    marginHorizontal: 6,
    flex: 1,
    backgroundColor: isIOS ? Color.transparent : SYSTEM_BLUR_2,
    borderRadius: 16,
    padding: 6,
    overflow: 'hidden',
  },
